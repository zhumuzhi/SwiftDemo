...
// MARK:base64 -> String
func base64DecodeString(string: String) -> String {
...
// MARK:json -> String
func jsonToString(any: Any) -> String {
...
//func callToNum(numString: String) {
...
// MARK: 保存
func userDefaultSaveKey(key: String, value: String?) -> Void {
    return UserDefaults.standard.setValue(value, forKey: key)
}

// MARK: 读取
func userDefaultReadKey(key: String) -> String? {
    return UserDefaults.standard.object(forKey: key) as? String
}

// MARK: 保存 - 数组
func userDefaultSaveArray(key: String, value: Array<Any>) -> Void {
    return UserDefaults.standard.set(value, forKey: key)
}

// MARK: 读取 - 数组
func userDefaultReadArray(key: String) -> Array<Any> {
